...
namespace Vortak {
    Camera::Camera(Vortak::InputDispatcher* inputDispatcher) : mInputDispatcher(inputDispatcher) {
    }

    void Vortak::Camera::setOrthographicProjection(float left, float right, float top, float bottom, float nearPlane,
                                                    float farPlane) {
    ...
    void Camera::onUpdate(const Vortak::Timestep& timeStep) {
    ...
    bool Camera::onWindowResize(const Vortak::WindowResizeEvent& event) {
    ...
    bool Camera::onMouseMove(const Vortak::MouseMovedEvent& event) {
